...
public class App {
        ...
        do {
            ...
            switch (userInput.toCharArray()[0]) {
                case '1':
                    ...
                    break;
                case '2':
                    Predicate<BankTransfer> p = getPredicate(scanner);
    ...
    public static Predicate<BankTransfer> getPredicate(Scanner scanner) {
        Predicate<BankTransfer> p;
        Search s;
        String userInput;
        boolean stopFlag = false;
        System.out.println("\n\n\n************ Search Menu: ***************");
        ...
        switch (userInput.toCharArray()[0]) {
            case '1':
                ...
                p = candidate -> candidate.getTransactionId().equals(finalUserInput);
                break;
            case '2':
            ...
            case '5':
                ...
                userInput = scanner.nextLine();
                finalUserInput = userInput;
                p = candidate -> candidate.getTransactionCurrency().equals(finalUserInput);
                break;
            default:
